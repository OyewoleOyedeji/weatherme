<template>
  <main class="container centre">
    <div id="dynamic-content" v-if="initialPageLoad && device != 'mobile'">
    ...
    <div id="dynamic-content" v-else-if="device != 'mobile'">
      <div v-if="online">
        <div v-if="!error">
          <h1>Hello World</h1>
        </div>
    ...
    <div id="dynamic-content" v-else>
      <div class="card shadow" id="glassmorphism-card">
        <div class="card-body">
          ...
          <h1 class="text-center pt-3 pb-3 caption">your device is not supported</h1>
        </div>
      </div>
    </div>
  </main>
