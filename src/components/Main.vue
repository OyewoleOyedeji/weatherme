<template>
  <main class="container centre">
    <div class="card shadow" id="glassmorphism-card">
      <!-- Loaded chunk -->
      <div class="card-body" v-if="isPageLoad && device != 'mobile'">
        <svg
        ...
        <h1 class="text-center pt-3 pb-3 caption">{{ comments }}</h1>
      </div>
      <!-- Loaded chunk -->
      <div
        class="card-body"
        v-else-if="
          (isPageLoad && device == 'mobile') ||
          (!isPageLoad && device == 'mobile')
        "
      >
        <svg
      ...
      <!-- Loaded chunk -->
      <div class="card-body" v-else-if="!isPageLoad && device != 'mobile'">
        <div v-if="online">
          <h1>Edit this later</h1>
        </div>
        <div v-else-if="!online && request.error">
          <div v-if="request._status === 0">
            <svg
          ...
          <div v-else-if="request._status === 400">
            <svg
          ...
          <div v-else-if="request._status === 403">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              id="currentIllo"
              data-name="Layer 1"
...
export default {
  ...
  created() {
    if (this.device != "mobile") {
      this.$store.commit("setComments", "c'mon your search");
    } else if (this.device == "mobile") {
      this.$store.commit("setComments", "your device isn't supported yet");
    }
  },
};
</script>