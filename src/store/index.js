        ...
        condition: {
          icon: () => {
            if (raw.current.condition.code === 1000) {
              ...
              raw.current.condition.code === 1006 ||
              raw.current.condition.code === 1009
            ) {
              var iconClass = "bi bi-cloud-sun";
              return iconClass;
            } else if (
              raw.current.condition.code === 1030 ||
              raw.current.condition.code === 1135
            ) {
              var iconClass = "bi bi-cloud-fog";
              return iconClass;
            } else if (
              raw.current.condition.code === 1063 ||
              ...
              raw.current.condition.code === 1066 ||
              ...
              raw.current.condition.code === 1069 ||
              ...
              raw.current.condition.code === 1171 ||
              ...
              raw.current.condition.code === 1186 ||
              raw.current.condition.code === 1246
            ) {
              var iconClass = "bi bi-cloud-rain";
              return iconClass;
            } else if (
              raw.current.condition.code === 1273 ||
